...
import { MacroscopicWave } from './MacroscopicWave';
import type { ScrollStateRef } from './types';
...
export const ScrollRig = ({ scrollState, reducedMotion, isDark }: ScrollRigProps) => {
