    ...
    <Float rotationIntensity={0.4} floatIntensity={0.25} speed={1.1}>
      <group ref={assemblyRef}>
        <Cylinder args={[1.2, 1.2, 0.08, 32]} position={[0, 1, 0]}>
          <meshStandardMaterial color={isDark ? COLORS.nobelGoldMuted : COLORS.nobelGold} metalness={1} roughness={0.1} />
        </Cylinder>
        ...
        <Torus args={[0.7, 0.012, 12, 48]} position={[0, -0.2, 0]} rotation={[Math.PI / 2, 0, 0]}>
          <meshStandardMaterial color={COLORS.copper} metalness={0.9} roughness={0.2} />
        </Torus>
        ...
        <Box args={[0.25, 0.04, 0.25]} position={[0, -0.7, 0]}>
          <meshStandardMaterial
            ...
            metalness={0.8}
            roughness={0.2}
            emissive={isDark ? COLORS.nobelGold : '#000'}
