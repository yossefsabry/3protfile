  ...
  return (
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 5], fov: 45 }} dpr={[1, 1.5]} gl={{ powerPreference: 'high-performance', antialias: true }}>
        ...
        <spotLight position={[5, 5, 5]} angle={0.25} penumbra={1} intensity={isDark ? 3.2 : 2} color={COLORS.nobelGold} />
        <pointLight position={[-5, -5, -5]} intensity={0.5} />
        <pointLight position={[0, 2.5, 2]} intensity={isDark ? 0.8 : 0.4} color={COLORS.nobelGoldLight} />
